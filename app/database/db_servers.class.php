...
class db_servers extends database {
    ...
    public function modify($id, $name, $content, $skills, $filename_list) {
        return $this->update(TABLE_SERVERS, array("name" => $name, "content" => $content, "skill" => $skills, "pic" => $filename_list), "id = '$id'");
    }
