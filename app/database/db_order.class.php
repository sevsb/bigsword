...
class db_order extends database {
    ...
    public function add($staff_id, $service_id, $start_time) {
        return $this->insert(TABLE_ORDERS, array("staff_id" => $staff_id, "service_id" => $service_id, "start_time" => $start_time, "status" => 1));
    }
